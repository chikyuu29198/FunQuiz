...
class FlatListItem extends Component {
    ...
    _onPress(level){
       ...
       console.log(test + "test Asyn in punch Level.js")
    ...
    //    console.log("test" + store.getState().updateLevel)
       this.props.navigation.navigate('PunchMouseGameWorld', {
                                        data: quizLevel
       })
    }
...
class PunchMouseLevel extends Component {
  constructor(props){
    super(props)
    this.state = {
        listData: []
...
export default connect(mapStateToProps)(PunchMouseLevel); 
